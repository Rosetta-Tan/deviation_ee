...
parser.add_argument('--log_dir', type=str, required=False, default='/n/home01/ytan/scratch/deviation_ee/old/output/20240425_powermethod_z2_newtol', help='directory to save log files')
parser.add_argument('--vec_dir', type=str, required=False, default='/n/home01/ytan/scratch/deviation_ee/old/vec_syk_pm_z2_newtol', help='directory to save state vectors')
parser.add_argument('--msc_dir', type=str, required=False, default='/n/home01/ytan/scratch/deviation_ee/old/msc_syk', help='directory to save msc files')
parser.add_argument('--obs_dir', type=str, required=False, default='/n/home01/ytan/scratch/deviation_ee/old/obs_syk', help='directory to save obs files')
