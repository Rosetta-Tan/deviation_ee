...
parser.add_argument('--log_dir', type=str, required=False, default='/n/home01/ytan/scratch/deviation_ee/old/output/solve_extrm_eigvals',  help='log directory')
parser.add_argument('--res_dir', type=str, required=False, default='/n/home01/ytan/scratch/deviation_ee/old/output/solve_extrm_eigvals',  help='output directory')
...
def main():
    ...
    eval = H.eigsolve(which='exterior', tol=1e-5)    
