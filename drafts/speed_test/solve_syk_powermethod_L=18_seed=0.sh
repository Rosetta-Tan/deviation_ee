...
# srun --mpi=pmix -n $SLURM_NTASKS python -O /n/home01/ytan/deviation_ee/syk/solve_syk_powermethod.py -L 18 --seed 0 --state_seed 0 --tol_coeff 1e-05
...
mamba deactivate
singularity exec --nv /n/holystore01/LABS/yao_lab/Lab/dynamite/sifs/dynamite_latest-cuda.sif python /n/home01/ytan/deviation_ee/syk/solve_syk_powermethod.py -L 18 --seed 0 --state_seed 0 --tol_coeff 1e-05 --vec_dir /n/home01/ytan/deviation_ee/tests/speed_test/
