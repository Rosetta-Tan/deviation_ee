...
def build_GA(save=False):
    ...
    for i1, inds1 in enumerate(iterator1):  # inds1 is a tuple of 4 indices
        for i2, inds2 in enumerate(iterator2):
    ...
    if save == True:
        GA.save(os.path.join(args.msc_dir, 
            f'GA_L={args.L}_LA={args.LA}_seed={args.seed}_dnm.msc'))
    return GA
