...
singularity exec --nv /n/holystore01/LABS/yao_lab/Lab/dynamite/sifs/dynamite_latest-cuda.sif python /n/home01/ytan/deviation_ee/syk/measure_obs.py --L {L} --seed $SLURM_ARRAY_TASK_ID --tol {tol} --vec_dir {vec_dir} --gpu --save True
''')
    rsh.close()
