...
# NOTE: For L=24, seeds 17 and 19 already reaches 3 days!
# seeds = list(set(range(20)) - set([15, 17, 19]))

tols = [1e-1]

# task 20240404
# JOBNAME = 'syk_pm_long'
# dir = '/n/home01/ytan/scratch/deviation_ee/output/20240404_powermethod_step_time_test'
...
''')
    ...
    # command += ["--partition=gpu_test", "--time=0-02:00", "--mem=2G", "--constraint="]  # for test purpose
    command += [file_name]
    if args.dry_run:
      print(command)
    else:
