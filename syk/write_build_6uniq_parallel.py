...
for seed in range(10):  # 10 seeds
  file_name = os.path.join(dir, f"L={L}_seed={seed}_parallel.sh")
...
srun --mpi=pmix -n $SLURM_NTASKS singularity exec /n/home01/ytan/src/dynamite_latest.sif python /n/home01/ytan/deviation_ee/syk/build_syk_H2_6uniq_parallel.py -L {L} --seed {seed}
''')