...
# srun --mpi=pmix -n $SLURM_NTASKS python -O /n/home01/ytan/deviation_ee/syk/solve_syk_powermethod.py --vec_dir {vec_dir} --log_dir {dir} -L {L} --seed $SLURM_ARRAY_TASK_ID --tol {tol}
