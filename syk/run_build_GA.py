...
singularity exec --nv /n/holystore01/LABS/yao_lab/Lab/dynamite/sifs/dynamite_latest-cuda.sif python /n/home01/ytan/deviation_ee/syk/build_GA.py --L {L} --LA {LA} --seed $SLURM_ARRAY_TASK_ID --gpu 1
''')
  rsh.close()
